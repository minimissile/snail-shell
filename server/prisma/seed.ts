...
async function main() {
  ...
  await prisma.city.createMany({
    data: [
      { code: 'SZ', name: '深圳', letter: 'S', isHot: true, sortOrder: 1 },
      { code: 'GZ', name: '广州', letter: 'G', isHot: true, sortOrder: 2 },
      { code: 'SH', name: '上海', letter: 'S', isHot: true, sortOrder: 3 },
      { code: 'BJ', name: '北京', letter: 'B', isHot: true, sortOrder: 4 },
      { code: 'HZ', name: '杭州', letter: 'H', isHot: true, sortOrder: 5 },
      { code: 'CD', name: '成都', letter: 'C', isHot: false, sortOrder: 6 },
      { code: 'NJ', name: '南京', letter: 'N', isHot: false, sortOrder: 7 },
      { code: 'WH', name: '武汉', letter: 'W', isHot: false, sortOrder: 8 },
      { code: 'XM', name: '厦门', letter: 'X', isHot: false, sortOrder: 9 },
      { code: 'QD', name: '青岛', letter: 'Q', isHot: false, sortOrder: 10 },
    ],
  })
